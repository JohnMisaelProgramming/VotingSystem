...
/* Custom styles for the election cards */
        ...
        .rcard select {
            margin-top: auto; /* Push select to the bottom */
        }
        .flex-grow-1 h5,
        .flex-grow-1 p,
        .flex-grow-1 small,
...
<div class="container rcard shadow-lg">
        ...
        <div class="col-md-6 mb-4">
            <div class="profile-card shadow-lg">
                <div class="card-body d-flex align-items-center">
                    ...
                    <i class="bi bi-eye-fill fs-4  ms-3 custom-eye-icon"></i>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-4">
            ...
            <div class="profile-card shadow-lg">
                <div class="card-body d-flex align-items-center text-start">
                    ...
                    <i class="bi bi-eye-fill fs-4 custom-eye-icon ms-3"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- Secretary --}}
    <div class="row mb-4">
    <h4 class="text-primary text-center mb-3">Secretary</h4>
        <div class="col-md-6 mb-4">
            <div class="profile-card shadow-lg">
                <div class="card-body d-flex align-items-center text-start">
